...
- Each headline should be short (<= 8 words). Pick ONE word/phrase from the headline as "keyword" (it renders in green) — the keyword MUST appear verbatim inside the headline.
- Keep body copy tight, benefit-led, "you"/"we" language. Never invent statistics — for "stat" slides use a plausible ROUND illustrative figure and set "caption" so it reads as illustrative, OR pull only from the narrative pillars.
